...
export const SKIP_KEYS = new Set(["id", "pda_encyclopedia_name", "hasNpcWeaponDrop", "hasStashDrop", "inStartingLoadout", "unobtainable", "integralOnly", "tacticalKit", "nimble", "kitSuffix", "kitSuffixNum", "nameSuffixKey", "nameSuffixNum", "hasDisassemble", "st_data_export_description", "base_mag_size"]);
...
export const CAT = {
    ...
    AMMO: "Ammo", EXPLOSIVES: "Explosives", MAGAZINES: "Magazines",
...
export const CATEGORY_KEYS = {
    ...
    [CAT.AMMO]: "app_cat_ammo", [CAT.EXPLOSIVES]: "app_cat_explosives", [CAT.MAGAZINES]: "app_cat_magazines",
...
export const CATEGORY_GROUPS = [
    ...
    { name: "app_group_items", categories: [CAT.WEAPON_PARTS, CAT.OUTFIT_PARTS, CAT.MISC] },
];
