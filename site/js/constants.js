...
export const SKIP_KEYS = new Set(["id", "pda_encyclopedia_name", "hasNpcWeaponDrop", "hasStashDrop", "inStartingLoadout", "unobtainable", "tacticalKit", "kitSuffix", "kitSuffixNum", "hasDisassemble", "st_data_export_description"]);
