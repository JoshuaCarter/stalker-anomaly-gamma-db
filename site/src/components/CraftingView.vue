...
const HOVER_SKIP = new Set([
    ...
    "hasNpcWeaponDrop", "hasStashDrop", "inStartingLoadout", "unobtainable", "tacticalKit", "nimble", "kitSuffix", "kitSuffixNum", "nameSuffixKey", "nameSuffixNum", "hasDisassemble", "st_data_export_description",
