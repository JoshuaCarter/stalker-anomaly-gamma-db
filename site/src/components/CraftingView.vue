...
const HOVER_SKIP = new Set([
    ...
    "hasNpcWeaponDrop", "hasStashDrop", "inStartingLoadout", "unobtainable", "integralOnly", "tacticalKit", "nimble", "kitSuffix", "kitSuffixNum", "nameSuffixKey", "nameSuffixNum", "hasDisassemble", "st_data_export_description",
