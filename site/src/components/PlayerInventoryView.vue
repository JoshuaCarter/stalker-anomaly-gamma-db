...
.pi-wip-banner {
    ...
    background: var(--color-orange-tint-12);
    border-radius: 6px;
    color: var(--text);
    font-size: 0.8rem;
    line-height: 1.3;
