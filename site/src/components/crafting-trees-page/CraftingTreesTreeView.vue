    ...
    methods: {
        ...
        nodeStats(item) {
            ...
            const SKIP = new Set([
                ...
                "hasNpcWeaponDrop", "hasStashDrop", "inStartingLoadout", "unobtainable", "integralOnly", "tacticalKit", "nimble", "kitSuffix", "kitSuffixNum", "nameSuffixKey", "nameSuffixNum", "hasDisassemble",
