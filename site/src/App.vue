...
<HeaderBar
    ...
    :loadout-mods="loadoutMods"
    :active-loadout-mod="activeLoadoutMod"
    ...
    @set-loadout-mod="(id) => setLoadoutMod(id)"
...
<div class="layout" :class="{ 'sidebar-collapsed': sidebarCollapsed, 'sidebar-hidden': buildPlannerActive || mapsActive || damageSimActive || tradingActive || playerInventoryActive || versionCompareActive || startingLoadoutsActive || factionPoolsActive || toolsLandingActive }">
    ...
    <main class="content" :class="{ 'content-maps': mapsActive, 'content-inventory': playerInventoryActive }">
        ...
        <PlayerInventoryView
            ...
            :hide-no-drop="hideNoDrop"
            :hide-tactical-kit="hideTacticalKit"
            :plate-mitigation="buildPlateMitigation"
            :hit-zone="buildHitZone"
            :zone-split-active="buildZoneSplitActive"
            @set-hit-zone="(zone) => setBuildHitZone(zone)"
            ...
            @equip-loadout="setManualLoadout"
            @set-loadout-ammo="setManualLoadoutAmmo"
            ...
            @open-comparison="compareSelectedItems"
            @navigate-to-item="navigateToItem"
        ...
        <div v-if="damageSimMounted" v-show="damageSimActive" class="ballistics-view">
          <DamageSimulator
            ...
            :weapon-addon-status="weaponAddonStatusCache || {}"
        ...
        <div v-show="!loading && !mapsActive && !damageSimActive && !tradingActive && !playerInventoryActive && !toolsLandingActive" class="content-inner">
            ...
            <BuildPlanner
                ...
                :build-hit-zone="buildHitZone"
                :build-zone-split-active="buildZoneSplitActive"
                @set-build-hit-zone="(zone) => setBuildHitZone(zone)"
...
<ItemDetailModal
    ...
    :modal-compatible-magazines="modalCompatibleMagazines"
    :modal-magazine-compatible-weapons="modalMagazineCompatibleWeapons"
...
export default {
  ...
  provide() {
    return {
      ...
      fireModeLabel: this.fireModeLabel,
      fireModeLabelShort: this.fireModeLabelShort,
